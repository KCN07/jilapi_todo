...
function Allschedules() {
    ...
    <h1 style={{color: "White", textAlign: "center", marginTop: "20px", fontFamily: "serif", fontWeight: "bolder"}}><button type="button" className="btn btn-default btn-circle-sm"><i className="fas fa-calendar-alt"></i>
    </button> All Schedules</h1>
    ...
    <div className="todos">
      ...
      <div className="card shadow-lg" style={{width: "35rem", marginTop: "3rem", borderRadius: ".55rem", fontFamily: "serif"}}>
          <div className="card-body">
              ...
              <h6 className="card-subtitle mb-2 text-muted">Start Time:</h6>
              <h6 className="card-subtitle mb-2 text-muted">Duration:</h6>
              <h6 className="card-subtitle mb-2 text-muted">Reminder Before:</h6>
        ...
        <div className="card shadow-lg" style={{width: "35rem", marginTop: "3rem", borderRadius: ".55rem", fontFamily: "serif"}}>
          ...
          <div className="col-md-5">
              <div className="card shadow-lg p-4 bg-white rounded" style={{width: "30rem", marginTop: "3rem", borderRadius: ".55rem", fontFamily: "serif"}}>
